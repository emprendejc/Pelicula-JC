...
echo '<div class="eael-content-timeline-block">
    ...
    echo '<div class="eael-content-timeline-content">';
        if( 'yes' == $settings['eael_show_title'] ) {
            echo '<'.Utils::validate_html_tag($settings['title_tag']).' class="eael-timeline-title"><a href="'.esc_url( get_the_permalink() ).'">'.get_the_title().'</a></'.Utils::validate_html_tag($settings['title_tag']).'>';
        }
