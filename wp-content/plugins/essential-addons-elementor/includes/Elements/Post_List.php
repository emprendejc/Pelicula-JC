...
//            );
    ...
    protected function render()
    {
        ...
        $data_settings = [
            ...
            'eael_post_list_title_tag' => Utils::validate_html_tag($settings['eael_post_list_title_tag']),
        ...
        if ($settings['eael_post_list_featured_area'] == 'yes' && !empty($settings['featured_posts'])) {
            ...
            if ($settings['eael_post_list_layout_type'] == 'preset-2') {
                ...
                if ($settings['eael_post_list_featured_title'] == 'yes' && !empty($settings['eael_post_list_title_tag'])) {
                    echo '<' . Utils::validate_html_tag($settings['eael_post_list_title_tag']) . ' class="eael-post-list-title">
		                                        <a href="' . get_the_permalink() . '">' . get_the_title() . '</a>
		                                    </' . Utils::validate_html_tag($settings['eael_post_list_title_tag']) . '>';
                }
