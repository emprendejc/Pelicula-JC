	...
	protected function _register_controls_style_cart_table() {
		...
		$this->add_control(
			...
			[
				...
				'size_units'            => [ 'px', '%' ],
				'selectors'             => [
					'{{WRAPPER}} .woocommerce .cart' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'             => [
					'{{WRAPPER}} .woocommerce table.cart .remove' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function _register_controls_style_cart_totals() {
		...
		$this->add_group_control(
			...
			[
				...
				'placeholder'           => '1px',
				'default'               => '1px',
				'selector'              => '{{WRAPPER}} .woocommerce .cart_totals .shop_table tr th,{{WRAPPER}} .woocommerce .cart_totals .shop_table tr td',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units'            => [ 'px', '%' ],
				'selectors'             => [
					'{{WRAPPER}} .woocommerce .cart_totals .shop_table' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
