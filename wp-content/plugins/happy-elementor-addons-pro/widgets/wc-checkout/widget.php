	...
	protected function _register_controls_style_billing_details() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .woocommerce .woocommerce-checkout .payment_box',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woocommerce .woocommerce-checkout .payment_box' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .woocommerce .woocommerce-checkout .payment_box'        => 'background-color: {{VALUE}};',
					'{{WRAPPER}} .woocommerce .woocommerce-checkout .payment_box:before' => 'border-bottom-color: {{VALUE}};',
				],
			]
		);
